...
export default function LandingPage() {
  ...
  return (
    <div className="landing-theme landing-shell min-h-screen">
      ...
      >
        <div className="mx-auto flex max-w-[1920px] items-center justify-center px-5 sm:px-8 lg:px-24">
          <a
            href="#hero"
            className={cn(
              'landing-link-accent landing-wordmark landing-inview-display text-2xl font-black text-(--landing-gold) transition-colors duration-200 hover:text-(--landing-gold-soft)',
